      ...
      <div className="space-y-5">
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-[20px] bg-white/[0.03] p-4 border border-white/[0.04]">
            ...
            <p className="mt-3 text-3xl font-black text-green-400">{recommendation.bias}</p>
          </div>
          <div className="rounded-[20px] bg-white/[0.03] p-4 border border-white/[0.04]">
            <p className="text-xs uppercase tracking-[0.3em] text-gray-500">Confidence</p>
            <p className="mt-3 text-3xl font-black text-cyan-400">{recommendation.confidence}</p>
          </div>
        </div>
        ...
        <div className="rounded-[20px] bg-white/[0.03] p-4 border border-white/[0.04]">
          ...
          <p className="mt-3 text-sm leading-relaxed text-gray-300">{recommendation.suggestedTrade}</p>
        </div>
      </div>
    </DashboardCard>
  );
